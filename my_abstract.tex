...
\section{研究背景・目的}
炭素繊維強化プラスチック(CFRP)は高比剛性・軽量性を有し，宇宙輸送機構造への適用が進んでいる．一方で，層間剥離をはじめとする内部欠陥の検出は難しく，運用段階での高効率な非破壊検査が課題である\cite{nondestructive_testing}．
近年は，表面主応力和分布(DSPSS)と機械学習を組み合わせた欠陥推定が報告されており，FEMデータに基づく推定の有効性が示されている\cite{cfrp_kojima}．しかし，宇宙輸送機構造を対象とし，実験由来データを学習過程に組み込んだ枠組みは十分に整理されていない．
本研究では，宇宙輸送機非破壊検査のための赤外線応力測定と機械学習を統合し，シミュレーション中心の枠組みを実験統合型へ拡張することを目的とする．
